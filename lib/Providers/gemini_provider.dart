...
class AIProvider extends StateNotifier<String> {
  ...
  Future<void> generateProblem({
    ...
    final adaptationP =
        'Перевір наступні параметри: Умова: Умова задачі на зображенні, Інтерес/Гоббі:$hobby ;'
        ...
        'Інакше адаптуй умову задачі УКРАЇНСЬКОЮ мовою під вказане хобі;' 
        'Змінюй лише сюжетний контекст: усі числові дані, математична логіка та суть задачі повинні залишитися незмінними й адаптуватися логічно; '
        'Не використовуй слова інших мов; Поверни ЛИШЕ текст нової умови, без жодних пояснень чи вступних фраз.';
